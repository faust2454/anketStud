...
namespace anketResult
{
    class Db
    {
        ...
        public string serverName = "ws.aiec.local"; // Адрес сервера (для локальной базы пишите "localhost")
        public string log = "ws"; // Имя пользователя
        public string dbName = "anketa"; //Имя базы данных
        public string port = "3306"; // Порт для подключения
        public string password = "123qweR%"; // Пароль для подключения
